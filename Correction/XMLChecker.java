...
import java.util.ArrayList;
 ...
 public class XMLChecker {
    ...
    public boolean checked; //set initially to false
    private int errorCount; //set initially to zero
    private ArrayList<String> tags;//container for all the tags
    private ArrayList<String> words; //container for everything else in XMLText other than the tags  
    private ArrayList<String> errors; //container for error locations and  descriptions
    private StringBuilder correctXMLText; //new String for the correct XML text 
    ...
    public static boolean isPreprocessorTag(String tag) {
        return tag.charAt(0) == '<' && tag.charAt(1) == '?' && tag.charAt(tag.length() - 1) == '>';
    }
}
